# 코드출처 : https://jinho-study.tistory.com/231
# xml 파일 출처 : https://github.com/opencv/opencv/tree/master/data/haarcascades

import numpy as np
import cv2

xml = 'haarcascade_frontalface_default.xml' # 얼굴 검출
...
cap = cv2.VideoCapture(0) # 0이면 노트북 웹캠을 카메라로 사용, 파일명으로 입력해서 사진이나 동영상 불러오기 가능
cap.set(3,640) # 너비
cap.set(4,480) # 높이

# 3번에 사용할 이미지 불러오기
img = cv2.imread('frog.jpg', cv2.IMREAD_UNCHANGED) # 원본 사용
